...
const onggojibDoubleGentleSprite = `${ONGGOJIB_CHARACTER_ROOT}onggojib_double_real_source_pixel.png`;
...
const onggojibBackgroundAssets = {
  ...
  'ong-snow-road': `${ONGGOJIB_BACKGROUND_ROOT}onggojib_snow_road_pixel.png`,
